...
def paginate_questions(request, selection):
    ...
    current_questions = [q.format() for q in selection[start:end]]
...
def create_app(test_config=None):
    ...
    -> DONE (an improvement will be to trigger the refresh
    or to use a state to update the page)
    '''
    ...
    -> DONE (It will good to get a feedback displayed
    to the user that it was successull)
    '''
    ...
    def post_question():
        ...
        # add a test to avoid creating empty questions
            ...
            try:
                ...
                categoriesDB = Category.query.order_by(Category.id).all()
                categories = {cat.id: cat.type for cat in categoriesDB}
